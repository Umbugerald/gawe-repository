...
$sqlPelanggan = "SELECT
    ...
    u.no_wa,
    u.created_at
FROM profile_pelanggan p
JOIN master_user u ON p.id_users = u.id_users
WHERE 1=1";
...
if ($search !== '') {
    $sqlPelanggan .= " AND (p.id_pelanggan LIKE ? OR u.nama_lengkap LIKE ?)";
    $searchTerm = "%$search%";
    $params[] = $searchTerm;
    $params[] = $searchTerm;
    $types .= "ss";
...
$sqlPelanggan .= " ORDER BY u.created_at DESC";

$stmt = mysqli_prepare($conn, $sqlPelanggan);
...
<head>
    ...
    <title>Pelanggan - Yang Penting Kerja</title>
...
<body>
    ...
    <div class="app-wrapper">
        ...
        <nav class="nav-menu">
            ...
            <a href="pelanggan-admin.php" class="nav-item active">
                <svg viewBox="0 0 24 24">
        ...
        <main class="main-content">
            ...
            <form action="" method="GET" class="search-container">
                <div class="search-box">
                    <input type="text" name="search" placeholder="Cari nama pelanggan, id pelanggan"
                            ...
                            <?php if (mysqli_num_rows($result) > 0): ?>
                                ...
                                while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['nama_lengkap'] ?? 'Pelanggan'); ?></td>
    ...
    <div class="modal-overlay" id="detailModal">
        <div class="modal-card">
            ...
            <img src="" alt="Pelanggan" class="modal-avatar" id="detailAvatar">
    ...
    <script>
        window.bukaModalOrderDetail = function (btn) {
            ...
            if (noHp && noHp !== "") {
                ...
                const pesan = encodeURIComponent(`Halo ${nama}, saya dari staff admin tim Gawe.id. Saya mewakili tim Gawe dalam menyampaikan informasi serta menjalin komunikasi dengan pelanggan.`);
