...
<body>
    <div class="container">
        ...
        <p>Admin kami sedang memverifikasi data kamu. Halaman ini akan otomatis dialihkan setelah akunmu dinyatakan
            <strong>Aktif</strong>.
        </p>
        ...
        <a href="function/logoutWorker.php" class="btn-logout">
            <i class="fa-solid fa-right-from-bracket"></i> Keluar & Cek Nanti
        </a>
    </div>
